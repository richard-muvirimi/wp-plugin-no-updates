...
<div class="<?php esc_attr_e(NO_UPDATES_SLUG); ?> notice notice-info is-dismissible">
    <div>
        <div class="<?php esc_attr_e(NO_UPDATES_SLUG); ?>-prompt">
            <?php printf(__('Please consider enabling usage collection for %s. This helps us improve our product and provide better features to you in the future.', NO_UPDATES_SLUG), __('No Updates', NO_UPDATES_SLUG)); ?>
        </div>
